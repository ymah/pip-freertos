...
typedef enum instruction{
	READ_DOMID, UPDATE_DOMID, CREATE_DOM, ADD_KEY, READ_KEY, UPDATE_KEY, DELETE_KEY, SET_IO, GET_IO, SET_IO_DIR, SET_LED
}instruction_t;
...
typedef enum eventType{
	INMESSAGE, COMMAND, RESPONSE, GET_KEY, NW_IN, NW_OUT, OD_IC, SP1D_IC, SP2D_IC, SP3D_IC
}eventType_t;
